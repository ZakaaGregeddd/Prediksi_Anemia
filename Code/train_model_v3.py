...
try:
    ...
    # --- LANGKAH PENCEGAHAN 1: CEK DAN HAPUS DUPLIKAT ---
    initial_rows = data.shape[0]
    data.drop_duplicates(inplace=True)
    rows_after_dedup = data.shape[0]
    ...
    # --- LANGKAH PENCEGAHAN 2: CEK UKURAN DATA ---
    if rows_after_dedup < 100:
        print("\n⚠️ PERINGATAN: Dataset sangat kecil (di bawah 100 baris).")
        print("Skor 1.0000 pada Test Set mungkin tidak berarti. Pertimbangkan menambah data.")
    ...
    print("\nStarting GridSearchCV for model training and validation...")
    ...
    print("Pastikan file 'anemia.csv' ada di direktori '../Data' relatif terhadap script.")
